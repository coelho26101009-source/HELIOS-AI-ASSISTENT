...
* **Cérebro Híbrido:** Transição automática entre Groq (rápido/online) e Ollama local (fallback/offline).
...
* **Memória a Longo Prazo:** (Em desenvolvimento) Utilização de ChromaDB e SQLite para retenção de contexto.
